...
/* Check correlation with CLV */ proc corr 	data=sa.loyalty_history_clean;     var Salary CLV;  
...
handle division by zero */         case              > median(l.CLV) or   when sum(Total_Flights) > 0              	                 
